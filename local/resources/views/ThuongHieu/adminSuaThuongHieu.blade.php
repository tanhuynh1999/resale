...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="row" role="form" action="./post-sua-thuong-hieu  " method="POST"
                    enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" name="mathuonghieu" value="{{$thuonghieu->mathuonghieu}}" />
                    <div class="col-md-6">

                        <div class="form-group">
                            <span class="control-label col-md-2">Thương hiệu</span>
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="thuonghieu" require value="{{$thuonghieu->thuonghieu}}" />
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div>
                            <img src="contents/images/{{$thuonghieu->anhthuonghieu}}" />
                        </div>
                        <div class="form-group">
